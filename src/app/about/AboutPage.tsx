...
export default function About() {
    ...
    return (
        <main className="max-w-1210px margin-auto">
            <section aria-labelledby="about-bacot" className="animSlideUp sec-visible pad-bl-20px pad-top-48px pad-0-14px">
                ...
                <div className="flex flex-direc-clm jus-c-c align-itm-c height-432px pad-top-20px gap-10px">
                    <h1 id="about-bacot" className="font-size-3rem glow-text box-sdw-0-2-6px-dark-blue">About</h1>
                ...
                <div className="pos-rel sec-visible flex flex-direc-clm jus-c-c align-itm-inherit pad-top-10px gap-24px">
                    ...
                    <div className="pos-rel pad-btm-20px">
                        ...
                        <div className="pad-btm-40px">
                            ...
                            <h2 className="font-size-3-5rem txt-align-c pad-btm-20px">Detail info tentang Author tidak ditemukan</h2>
